defmodule NervesHubLinkAVM.JSON do
  ...
  defp escape_string(<<"\"", rest::binary>>, acc),
    do: escape_string(rest, <<acc::binary, "\\\"">>)
  ...
  defp decode_string(<<"\\u", _::binary-size(4), rest::binary>>, acc),
    do: decode_string(rest, acc)
